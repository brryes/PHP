...
if ($order_id) {
    ...
    <head>
        ...
        <style>
            body { background: #1a1a1a; color: #fff; font-family: 'Oswald', sans-serif; padding: 2rem; }
            .order-card { background: #2a2a2a; border: 1px solid #444; border-radius: 1rem; padding: 2rem; margin: 2rem auto; max-width: 500px; box-shadow: 0 0 10px #000; }
            .order-section-title { font-weight: 600; color: #b0b0b0; margin-bottom: 0.5rem; }
            .order-content { margin-bottom: 1rem; color: #fcd34d; }
            .back-btn { display: inline-block; background: transparent; border: 2px solid #ff4655; color: #ff4655; padding: 0.6rem 1.5rem; border-radius: 0.5rem; text-decoration: none; font-weight: bold; transition: 0.2s; }
            .back-btn:hover { background: #ff4655; color: #fff; }
        </style>
    </head>
    <body>
...
<body>
    ...
    <div class="text-center mt-10">
        <a href="home.php" class="back-btn">← Back to